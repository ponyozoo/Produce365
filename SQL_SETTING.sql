...
CREATE TABLE RATING (
    ...
    TRAINEE_ID INT REFERENCES TRAINEE(ID) ON DELETE CASCADE,
...
CREATE TABLE DEBUT_MEMBER(
    ...
    GROUP_ID INT NOT NULL REFERENCES DEBUT(ID) ON DELETE CASCADE,
    TRAINEE_ID INT NOT NULL REFERENCES TRAINEE(ID) ON DELETE CASCADE
);
CREATE TABLE CARE (
    ID INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE CARE_HISTORY (
    ...
    CARE_ID INT NOT NULL REFERENCES CARE(ID) ON DELETE CASCADE,
    TRAINEE_ID INT NOT NULL REFERENCES TRAINEE(ID) ON DELETE CASCADE
);
CREATE TABLE LESSON(
    ID INT AUTO_INCREMENT PRIMARY KEY,

...
CREATE TABLE RATING (
    ...
    FOREIGN KEY (TRAINEE_ID) REFERENCES TRAINEE(ID) ON UPDATE CASCADE,
...
CREATE TABLE DEBUT_MEMBER(
    ...
    TRAINEE_ID INT NOT NULL,
    FOREIGN KEY (GROUP_ID) REFERENCES DEBUT(ID) ON UPDATE CASCADE,
    FOREIGN KEY (TRAINEE_ID) REFERENCES TRAINEE(ID) ON UPDATE CASCADE
);
CREATE TABLE CARE (
    ID INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE CARE_HISTORY (
    ...
    TRAINEE_ID INT NOT NULL,
    FOREIGN KEY (CARE_ID) REFERENCES CARE(ID) ON UPDATE CASCADE,
    FOREIGN KEY (TRAINEE_ID) REFERENCES TRAINEE(ID) ON UPDATE CASCADE
);
CREATE TABLE LESSON(
    ID INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE LESSON_HISTORY (
    ...
    TRAINEE_ID INT NOT NULL,
    FOREIGN KEY (LESSON_ID) REFERENCES LESSON(ID) ON UPDATE CASCADE,
    FOREIGN KEY (TRAINEE_ID) REFERENCES TRAINEE(ID) ON UPDATE CASCADE
);
